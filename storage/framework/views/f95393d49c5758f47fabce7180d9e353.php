<footer>
    ...
    <div class="footer-area">
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-6 col-sm-4">
                    <div class="single-footer">
                        <h3 class="footer-title  title-border">TÀI KHOẢN</h3>
                ...
                <div class="col-xs-6 col-sm-4">
                    <div class="single-footer">
                        <h3 class="footer-title  title-border">MUA HÀNG</h3>
                        <ul class="footer-menu">
    ...
    <!-- Copyright-area start -->
</footer><?php /**PATH C:\ĐỒ ÁN\tot_nghiep\tot_nghiep\resources\views/components/footer.blade.php ENDPATH**/ ?>