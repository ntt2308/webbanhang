...
<head>
    ...
    <style>
        <?php echo \File::get(base_path('vendor/unisharp/laravel-filemanager/public/css/lfm.css')); ?>
...
<body>
    ...
    <nav class="bg-light fixed-bottom border-top d-none" id="actions">
        <a data-action="open" data-multiple="false"><i
                class="fas fa-folder-open"></i><?php echo e(trans('laravel-filemanager::lfm.btn-open')); ?></a>
        <a data-action="preview" data-multiple="true"><i
                class="fas fa-images"></i><?php echo e(trans('laravel-filemanager::lfm.menu-view')); ?></a>
        <a data-action="use" data-multiple="true"><i
                class="fas fa-check"></i><?php echo e(trans('laravel-filemanager::lfm.btn-confirm')); ?></a>
    </nav>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel"><?php echo e(trans('laravel-filemanager::lfm.title-upload')); ?>
                ...
                <div class="modal-body">
                    <form action="<?php echo e(route('unisharp.lfm.upload')); ?>" role='form' id='uploadForm'
                            ...
                            <div class="controls text-center">
                                <div class="input-group w-100">
                                    <a class="btn btn-primary w-100 text-white"
                                        id="upload-button"><?php echo e(trans('laravel-filemanager::lfm.message-choose')); ?></a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary w-100"
                        data-dismiss="modal"><?php echo e(trans('laravel-filemanager::lfm.btn-close')); ?></button>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary w-100"
                        data-dismiss="modal"><?php echo e(trans('laravel-filemanager::lfm.btn-confirm')); ?></button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        <?php echo \File::get(base_path('vendor/unisharp/laravel-filemanager/public/js/script.js')); ?>
...
<?php /**PATH C:\ĐỒ ÁN\tot_nghiep\resources\views/vendor/laravel-filemanager/index.blade.php ENDPATH**/ ?>