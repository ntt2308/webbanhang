                ...
                <?php if( isset($banners)): ?>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a style="padding: 5px 10px; border: 1px solid #995"
                                  href="<?php echo e(route('admin.get.action.banner',['delete',$banner->id])); ?>"
                                  onclick="return confirm('Bạn có chắc chắn muốn xóa banner này không?')">
                                  <i class="fa-solid fa-trash" style="font-size:11px"></i>Xoá
                                </a>
                        </td>
                    </tr>
...
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\tot_nghiep\tot_nghiep\tot_nghiep\Modules/Admin\resources/views/banner/index.blade.php ENDPATH**/ ?>