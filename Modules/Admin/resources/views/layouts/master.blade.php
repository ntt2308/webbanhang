    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{route('home')}}">Trang người dùng</a>
            </div>
            ...
            <div class="col-sm-3 col-md-2 sidebar" style="background: rgb(21, 26, 32)">
                <ul class="nav nav-sidebar" style="font-weight:750;font-size: 18px">
                    <li class="{{ \Request::route()->getName() == 'admin.home' ? 'active' : '' }}">
                        <a href="{{ route('admin.home') }}"><i class="fa fa-home" aria-hidden="true"></i> TRANG CHỦ</a>
                    </li>
                    <li class="{{ \Request::route()->getName() == 'admin.get.list.category' ? 'active' : '' }}">
                        <a href="{{ Route('admin.get.list.category') }}"  ><i class="fa fa-list" aria-hidden="true"></i> DANH MỤC</a>
                    </li>
                    <li class="{{ \Request::route()->getName() == 'admin.get.list.product' ? 'active' : '' }}"><a
                            href="{{ Route('admin.get.list.product') }}"><i class="fa fa-indent" aria-hidden="true"></i> SẢN PHẨM</a></li>
                    <li class="{{ \Request::route()->getName() == 'admin.get.warehouse' ? 'active' : '' }}"><a
                             href="{{ Route('admin.get.warehouse') }}"><i class="fa fa-bar-chart" aria-hidden="true"></i> KHO HÀNG</a></li>
